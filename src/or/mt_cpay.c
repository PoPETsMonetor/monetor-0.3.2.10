...
static int init_chn_end_setup(mt_channel_t* chn, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(&client.ledger, MT_NTYPE_CHN_END_SETUP, signed_msg, signed_msg_size);
  tor_free(msg);
  tor_free(signed_msg);
  return result;
}
...
static int help_chn_end_estab1(void* args){
  ...
  int result =  mt_buffer_message(&chn->idesc, MT_NTYPE_CHN_END_ESTAB1, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int handle_chn_int_estab2(mt_desc_t* desc, chn_int_estab2_t* token, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(desc, MT_NTYPE_CHN_END_ESTAB3, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int init_nan_cli_setup1(mt_channel_t* chn, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(&chn->idesc, MT_NTYPE_NAN_CLI_SETUP1, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int handle_nan_int_setup2(mt_desc_t* desc, nan_int_setup2_t* token, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(desc, MT_NTYPE_NAN_CLI_SETUP3, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int handle_nan_int_setup4(mt_desc_t* desc, nan_int_setup4_t* token, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(desc, MT_NTYPE_NAN_CLI_SETUP5, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int init_nan_cli_estab1(mt_channel_t* chn, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message_multidesc(&chn->rdesc, &chn->idesc, MT_NTYPE_NAN_CLI_ESTAB1,
					 msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int init_nan_cli_pay1(mt_channel_t* chn, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(&chn->rdesc, MT_NTYPE_NAN_CLI_PAY1, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int init_nan_cli_destab1(mt_channel_t* chn, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(&chn->idesc, MT_NTYPE_NAN_CLI_DESTAB1, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int init_nan_cli_dpay1(mt_channel_t* chn, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(&chn->idesc, MT_NTYPE_NAN_CLI_DPAY1, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int init_nan_cli_reqclose1(mt_channel_t* chn, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(&chn->rdesc, MT_NTYPE_NAN_CLI_REQCLOSE1, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int init_nan_end_close1(mt_channel_t* chn, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(&chn->idesc, MT_NTYPE_NAN_END_CLOSE1, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int handle_nan_int_close2(mt_desc_t* desc, nan_int_close2_t* token, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(desc, MT_NTYPE_NAN_END_CLOSE3, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int handle_nan_int_close4(mt_desc_t* desc, nan_int_close4_t* token, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(desc, MT_NTYPE_NAN_END_CLOSE5, msg, msg_size);
  tor_free(msg);
  return result;
}
...
static int handle_nan_int_close6(mt_desc_t* desc, nan_int_close6_t* token, byte (*pid)[DIGEST_LEN]){
  ...
  int result = mt_buffer_message(desc, MT_NTYPE_NAN_END_CLOSE7, msg, msg_size);
  tor_free(msg);
  return result;
}
